        ...
        <div className="space-y-1">
          {activities.map((activity, idx) => {
            ...
            return (
              ...
              >
                <div className="size-9 rounded-xl bg-PrimaryColorLight dark:bg-PrimaryColorDark/20 flex items-center justify-center flex-shrink-0">
                  <Icon size={16} className="text-PrimaryColor" />
                </div>
