...
const seekerSections: SidebarSection[] = [
  {
    ...
    items: [
      ...
      {
        label: 'Apply as Recruiter',
        href: '/dashboard/seeker/apply-recruiter',
        icon: UserPlus,
      },
  ...
  },
  {
    ...
    items: [
      {
        label: 'Career Coach',
        href: '/dashboard/seeker/career-coach',
        icon: Bot,
      },
      {
        label: 'Cover Letter Generator',
        href: '/dashboard/seeker/ai-tools',
        icon: ScrollText,
      },
      {
      ...
      },
      {
        ...
        href: '/dashboard/seeker/resume-analyzer',
        icon: FileText,
      },
    ],
  },
...
const adminSections: SidebarSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: 'Add Blog Post',
        href: '/dashboard/admin/posts/add',
        icon: FileText,
      },
    ],
  },
      ...
      <div className="flex h-16 items-center gap-3 px-4 border-b border-Border dark:border-secondary/40">
        <Link href="/" className="flex items-center gap-2.5 shrink-0">
          <Image
            ...
            src={logo}
            alt="logo"
            className="shrink-0 text-center mx-auto"
          />
          <AnimatePresence initial={false}>
            {showFullText && (
              <motion.span
                ...
                className="text-2xl font-PrimaryFont flex text-PrimaryColor font-bold whitespace-nowrap overflow-hidden"
              >
          ...
          {showFullText && (
            ...
            >
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span
                  className={`text-[10px] font-semibold font-SecondaryFont ${completionColor.text} whitespace-nowrap`}
                >
                  {completion}%
                </span>
              </div>
                      ...
                      >
                        <item.icon
                          ...
                          className={cn(
                            ...
                            showFullText && 'group-hover:scale-110',
                          )}
                        />
                        {showFullText && (
